...
class BudgetController extends Controller
{
	...
	public function index() {
		...
		if (Auth::user()->isrole('6')){
			return view( 'budget.index' )->with('data', $data);
		} else{
	...
	public function getdata() {
		...
		->addColumn( 'action', function ( $accountsingle ) {
				return '
				<a  href="#" id="btnedit" customdata='.$accountsingle->budgetid.' class="text-blue-sky" data-toggle="modal" data-target="#edit"><i data-toggle="tooltip" data-placement="top" title='. trans('lang.edit').' class="ti-pencil"></i></a>&nbsp;&nbsp;
				<a  href="#" id="btndelete" customdata='.$accountsingle->budgetid.' class="text-danger" data-toggle="modal" data-target="#delete"><i data-toggle="tooltip" data-placement="top" title='. trans('lang.delete').' class="ti-close"></i> </a>';
