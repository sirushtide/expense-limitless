...
class GoalController extends Controller
{
	...
	public function index() {
		...
		if (Auth::user()->isrole('7')){
			return view( 'goals.index' )->with('data', $data);
		} else{
	...
	public function getdata() {
		...
		->addColumn('action', function ($accountsingle) {
				...
				if($remaining <= 0 ){
					...
					return '<span class="label label-success">'.trans('lang.goal_reached').'</span>
					 <a  href="#" id="btnedit" customdata='.$accountsingle->goalsid.' class="text-blue-sky" data-toggle="modal" data-target="#edit"><i data-toggle="tooltip" data-placement="top" title='. trans('lang.edit').' class="ti-pencil"></i></a>&nbsp;&nbsp;
					<a  href="#" id="btndelete" customdata='.$accountsingle->goalsid.' class="text-danger" data-toggle="modal" data-target="#delete"><i data-toggle="tooltip" data-placement="top" title='. trans('lang.delete').' class="ti-close"></i> </a>';
				}else{

					return '
					<a  href="#" id="btndeposit" customdata='.$accountsingle->goalsid.' class="text-green" data-toggle="modal" data-target="#deposit"><i data-toggle="tooltip" data-placement="top" title='. trans('lang.deposit').' class="ti-plus"></i></a>&nbsp;&nbsp;
					<a  href="#" id="btnedit" customdata='.$accountsingle->goalsid.' class="text-blue-sky" data-toggle="modal" data-target="#edit"><i data-toggle="tooltip" data-placement="top" title='. trans('lang.edit').' class="ti-pencil"></i></a>&nbsp;&nbsp;
					<a  href="#" id="btndelete" customdata='.$accountsingle->goalsid.' class="text-danger" data-toggle="modal" data-target="#delete"><i data-toggle="tooltip" data-placement="top" title='. trans('lang.delete').' class="ti-close"></i> </a>';
				}
			})
