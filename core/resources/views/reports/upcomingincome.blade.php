						...
						<div class="content">
							<div class="row">
								...
								<div class="col-md-4 mt-4 mt-md-2">
								 ...
								 <select id="incomecategory" class="form-control" name="category" required data-url="{{ url('incomecategory/getdata')}}">
								 <option value=""><?php echo trans('lang.select_a_category');?></option>
								 </select>
								</div>
								<div class="col-md-4 mt-4 mt-md-2">
								 <label><?php echo trans('lang.sub_category');?></label>
								 <select id="incomesubcategory" class="form-control" name="subcategory" data-url="{{ url('incomecategory/subgetdatabycat')}}">
								 </select>
								</div>
							</div>	
							<div class="row">
