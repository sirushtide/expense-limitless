                      ...
                      <div class="header">
                        <div class="d-flex justify-content-between flex-sm-row flex-column">
                            ...
                            <div class="d-flex flex-row">
                                <a href="#'" data-toggle="modal" data-target="#add" class="btn btn-sm btn-fill btn-info"><i class="ti-plus"></i> <?php echo trans('lang.add_expense_category');?></a>
                            </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="">
            ...
            <div class="header">
                        <div class="d-flex justify-content-between flex-sm-row flex-column">
                            ...
                            <div class="">
                            <div class="d-flex flex-row">
                                <a href="#'" data-toggle="modal" data-target="#addsub" class="btn btn-sm btn-fill btn-info"><i class="ti-plus"></i> <?php echo trans('lang.add_sub_expense_category');?></a>
                            </div>
                            </div>
                        </div>
                    </div>
          ...
          <div class="modal-content">
            <form action="#" id="formadd"  autocomplete="off">
              <div class="modal-header">
                <h5 class="modal-title"><?php echo trans('lang.add_expense_category');?></h5>
...
<div id="addsub" class="modal fade" role="dialog">
        <div class="modal-dialog">
          <div class="modal-content">
            <form action="#" id="formsubadd"  autocomplete="off">
              <div class="modal-header">
                <h5 class="modal-title"><?php echo trans('lang.add_sub_expense_category');?></h5>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
              </div>
        ...
        <div class="form-group">
                 ...
                 <select id="expensecategory" data-url="{{ url('expensecategory/getdata')}}" class="form-control" name="expensecategory" required >
...
<!--delete data -->
<div id="getdeletesub" data-url="{{ url('expensecategory/subdelete')}}">
...
$(document).ready(function() {
  ...
  $("#formsubadd").validate({
      ...
      submitHandler: function(forms) {
        var category    = $("#addsub #expensecategory").val();
